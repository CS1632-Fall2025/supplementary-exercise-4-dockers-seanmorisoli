...
public class D3Test {
  ...
  public void tEST2RESET() {
    driver.get("http://localhost:8080");
    driver.manage().window().setSize(new Dimension(1472, 823));
  ...
  public void tEST8FEEDACAT() {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@onclick=\'setTimeout(feedSubmit, 1000)\']")));
    }
    {
  ...
  public void dEFECT2FUNGREETACATWITHNAME() {
    driver.get("http://localhost:8080");
    driver.manage().window().setSize(new Dimension(1472, 824));
